Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ 'http://action-cable-notifications.herokuapp.com', /http:\/\/action-cable-notifications.herokuapp.*/ ]
  ...
  # config.active_job.queue_name_prefix = "notifications_#{Rails.env}"
